<?php
    ...
    define('TITLE'," The Student Parlor");
...
?>  
    ...
    <body style="background: #f1f1f1">
      ...
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
          <img class="mr-3" src="img/logo3.png" alt="" width="48" height="48">
        <div class="lh-100">
          <h1 class="mb-0 text-white lh-100">The Student Parlors</h1>
          <small>Connecting People</small>
        </div>
      </div>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        ?>
        <a href="create-category.php" class="btn btn-primary">Create A Forum</a>
            <a href="categories.php" class="btn btn-primary">All Forums</a>
        </small>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h5 class="border-bottom border-gray pb-2 mb-0">Top Topics</h5>
        ...
        <small class="d-block text-right mt-3">
            <a href="create-topic.php" class="btn btn-primary">Create A Topics</a>
            <a href="topics.php" class="btn btn-primary">All Topics</a>
        </small>
