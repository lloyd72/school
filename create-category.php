<?php
    ...
    define('TITLE',"Create Category |  The Student Parlor");
			...
			<div class="wrap-contact2">
				<form class="contact2-form" method="post" action="includes/create-category.inc.php">
						...
						Create Forum
                                        ...
                                        <?php
                                            if(isset($_GET['error']))
                                            {
                                                ...
                                                {
                                                    echo '<h5 class="text-danger">*A forum with the given name already exists</h5>';
                                                }
					...
					<div class="wrap-input2 validate-input" data-validate="Name is required">
						...
						<span class="focus-input2" data-placeholder="Forum Name"></span>
					</div>
					...
					<div class="wrap-input2 validate-input" data-validate = "Description is required">
						...
						<span class="focus-input2" data-placeholder="Forum Description"></span>
					</div>
