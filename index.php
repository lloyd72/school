...
<?php
    ...
    define('TITLE',"GCTU|  The Student Parlor");
...
?> 
    ...
    <body onload="pageLoad()">
        ...
        <!-- <img src='img/blog.' id='loader-logo'>
            <div class="loader">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" >
                        ...
                        <div class="text-center p-3">
                            ...
                            <h2 class='text-muted'> The Student Parlor</h2>
                            <br>
                        </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                  ...
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-white lh-100">Latest The Student Parlor</h1>
                                  </div>
                                </div>  
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="forum.php" class="btn btn-warning btn-lg btn-block">The Student Parlors</a>
                        <a href="hub.php" class="btn btn-secondary btn-lg btn-block"> Hub</a>
                        <br><br><br>
                        <a href="create-topic.php" class="btn btn-warning btn-lg btn-block">Create The Student Parlor</a>
